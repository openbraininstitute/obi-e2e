...
/** Starts the workflow and picks the mesh, leaving the form open. */
...
test.describe('EM mesh skeletonization', () => {
  ...
  for (const configuration of fixture.cases) {
    test(
      `Generate a skeletonization campaign and launch it: ${configuration.name}`,
