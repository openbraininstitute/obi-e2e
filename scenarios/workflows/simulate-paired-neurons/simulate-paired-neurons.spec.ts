...
// Scenario: scenarios/workflows/simulate-paired-neurons/scenario.md
const fixture = loadScanConfigFixture('simulate-paired-neurons.json');
...
test.describe('Paired neurons simulation', () => {
