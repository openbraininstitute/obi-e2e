...
test.describe('ME-model details', () => {
  ...
  test('Open one ME-model beside the listing', { tag: AUTHENTICATED }, async ({ page }) => {
  ...
  test('Open the full ME-model page', { tag: AUTHENTICATED }, async ({ page }) => {
    test.slow();
    const view = dataView(page);
  ...
  test('Open simulate page from details view', { tag: AUTHENTICATED }, async ({ page }) => {
    test.slow();
    const view = dataView(page);
