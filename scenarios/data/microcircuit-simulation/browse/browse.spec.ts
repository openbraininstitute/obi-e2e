...
test.describe('Microcircuit listing', () => {
  ...
  test('See the Microcircuit table', { tag: AUTHENTICATED }, async ({ page }) => {
  ...
  test('See the Microcircuit results', { tag: AUTHENTICATED }, async ({ page }) => {
    const listing = entityListing(page);
  ...
  test('Search the Microcircuit listing', { tag: AUTHENTICATED }, async ({ page }) => {
    const listing = entityListing(page);
    await expect(listing.cells.first()).toBeVisible();
