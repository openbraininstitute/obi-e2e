...
// Scenario: scenarios/data/microcircuit-simulation/view/scenario.md
...
// The page carries nothing of its own yet, so reaching it is all there is
// to check. A section added later belongs in the list above.
