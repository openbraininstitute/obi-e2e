...
const SLUG = entitySlug(Type.SynthesizedCellMorphology);
...
test.describe('Synthesized morphology details', () => {
  ...
  test(
    'Open one Synthesized morphology beside the listing',
  ...
  test('Open the full Synthesized morphology page', { tag: PRIVATE_READONLY }, async ({ page }) => {
    test.slow();
    const view = dataView(page);
