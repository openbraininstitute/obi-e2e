...
const SLUG = entitySlug(Type.SingleNeuronCircuit);
...
const SECTIONS = ['viewer-scene', 'viewer-settings', 'metadata-grid', 'subject-details'];

test.use(WIDE_VIEWPORT);

test.describe('Synaptome details', () => {
