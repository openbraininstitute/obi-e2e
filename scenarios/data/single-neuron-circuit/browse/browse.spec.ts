...
test.describe('Synaptome listing', () => {
  ...
  test('See the Synaptome results', { tag: AUTHENTICATED }, async ({ page }) => {
    const listing = entityListing(page);
  ...
  test('Search the Synaptome listing', { tag: AUTHENTICATED }, async ({ page }) => {
    const listing = entityListing(page);
    await expect(listing.cells.first()).toBeVisible();
  ...
  test('Page through the Synaptome listing', { tag: AUTHENTICATED }, async ({ page }) => {
