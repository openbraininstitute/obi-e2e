...
// Scenario: scenarios/data/paired-neuron-circuit-simulation/scenario.md
...
test.describe('Paired neurons listing', () => {
  test.beforeEach(async ({ page, workspace }) => {
    await page.goto(
      routes.dataEntity(workspace.labId, workspace.projectId, 'paired-neuron-circuit-simulation')
    );
