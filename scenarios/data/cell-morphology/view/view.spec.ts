...
test.describe('Morphology details', () => {
  ...
  test('Open one Morphology beside the listing', { tag: PRIVATE_READONLY }, async ({ page }) => {
  ...
  test('Open the full Morphology page', { tag: PRIVATE_READONLY }, async ({ page }) => {
    test.slow();
    const view = dataView(page);
