...
test.describe('Single neuron listing', () => {
  ...
  test('See the Single neuron table', { tag: PRIVATE_READONLY }, async ({ page }) => {
  ...
  test('See the Single neuron results', { tag: PRIVATE_READONLY }, async ({ page }) => {
    const listing = entityListing(page);
  ...
  test('Search the Single neuron listing', { tag: PRIVATE_READONLY }, async ({ page }) => {
    const listing = entityListing(page);
    await expect(listing.cells.first()).toBeVisible();
