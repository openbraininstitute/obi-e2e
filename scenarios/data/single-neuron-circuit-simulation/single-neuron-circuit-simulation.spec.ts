...
// Scenario: scenarios/data/single-neuron-circuit-simulation/scenario.md
...
test.describe('Synaptome listing', () => {
  test.beforeEach(async ({ page, workspace }) => {
    await page.goto(
      routes.dataEntity(workspace.labId, workspace.projectId, 'single-neuron-circuit-simulation')
    );
