...
- Name: scenarios/data/state-persistence/state-persistence.spec.ts >> What the listing remembers >> The column layout outlives a fresh start
- Location: scenarios/data/state-persistence/state-persistence.spec.ts:89:2
